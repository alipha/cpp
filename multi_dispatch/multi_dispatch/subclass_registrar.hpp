...
struct subclass_registrar : ImmediateSuperclass {
    static_assert(std::is_base_of_v<Superclass, ImmediateSuperclass>, "ImmediateSuperclass does not derive from Superclass");
    static_assert(std::is_base_of_v<superclass_registrar<Superclass>, Superclass>, "Superclass does not derive from superclass_registrar<Superclass>");
